...
{\bf n \cdot \tau_{2} \cdot t} - {\bf n\cdot \tau_{1} \cdot t} = 0
\end{equation}
where $ {\bf t}$ is a unit tangent vector to the interface surface. This has got 2 components $ {\bf t_{z}}$ and ${\bf t_{\theta}$
\therefore ,
\begin{equation}
{\bf n \cdot \tau_{2} \cdot t_{z}} - {\bf n\cdot \tau_{1} \cdot t_{z}} = 0
\end{equation}
and ,
\begin{equation}
...
evaulating ,
\begin{equation}
{\bf n \cdot \tau \cdot t_{z}} = \sum_{l=1}^{3} (n_{l}{\bf e_{l}}) \cdot \bigg(\sum_{i=1}^{3}\sum_{j=1}^{3} (\tau_{ij}{\bf e_{i}e_{j}})\bigg)\cdot \bigg(\sum_{k=1}^{3} (t_{k}{\bf e_{k}})\bigg)  
\end{equation}
\begin{equation*}
{\bf {n \cdot \tau \cdot t_{z}}} = \sum_{l=1}^{3} (n_{l}{\bf e_{l}}) \cdot \bigg(\sum_{i=1}^{3}\sum_{j=1}^{3}\sum_{k=1}^{3} (\tau_{ij}  t_{k}({\bf e_{i}\delta_{jk}})\bigg)
\end{equation*}
\begin{equation*}
{\bf {n \cdot \tau \cdot t_{z}}} = \sum_{l=1}^{3} (n_{l}{\bf e_{l}}) \cdot \bigg(\sum_{i=1}^{3}\sum_{j=1}^{3} \tau_{ij}  t_{j}{\bf e_{i}}\bigg)
\end{equation*}
\begin{equation*}
{\bf {n \cdot \tau \cdot t_{z}}} = \sum_{l=1}^{3}\sum_{i=1}^{3}\sum_{j=1}^{3} \tau_{ij}t_{j}n_{l}({\bf e_{i} \cdot e_{l}})
\end{equation*}
\begin{equation*}
{\bf {n \cdot \tau \cdot t_{z}}} = \sum_{l=1}^{3}\sum_{j=1}^{3} \tau_{lj}t_{j}n_{l} = \sum_{l=1}^{3}n_{l}\sum_{j=1}^{3} \tau_{lj}t_{j}
\end{equation*}
\begin{equation}
{\bf {n \cdot \tau \cdot t_{z}}} = n_{1}(\tau_{11}t_{1} + \tau_{12}t_{2} + \tau_{13}t_{3}) +  n_{2}(\tau_{21}t_{1} + \tau_{22}t_{2} + \tau_{23}t_{3}) +  n_{3}(\tau_{31}t_{1} + \tau_{32}t_{2} + \tau_{33}t_{3}) 
\end{equation}
